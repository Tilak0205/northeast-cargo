    ...
    return(
        <>
            <div  className="section" style={{background: '#f1f1f157',borderRadius: '8px',padding: '14px 18px'}}>
                <h1 className='page-heading'><span className='font-blue'>Shipment Details:</span> <span className='font-green'>Road Freight</span> </h1>     
                
                <h2 className='font-green'>Type of Cargo: </h2>
                <Form
                    name="basic"
                    //labelCol={{ span: 8 }}
                    labelAlign="left"
                ...
                >
                    <Row gutter={16}>
                        ...
                        <Col span={6}>Non Food Product : </Col>
                        <Col span={18}>
                            <Form.Item valuePropName='1'
                        ...
                        <Col span={6} className='font-red'>Hazardous : </Col>
                        <Col span={18}>
                            <Form.Item valuePropName='1'
                                //label="Non Food Product"
                                name="non_food_product"
                                rules={[]}
                            >
                                <Switch /> &nbsp; &nbsp; <span className='font-red'>We do not deals with hazardous products</span>
                            </Form.Item>
  
                        </Col>

                        <Col span={6}>Product Commodity Code : </Col>
                        <Col span={18}>
                            <Form.Item
                                //label="Invoice Value"
                                name="commodity_code"
                                ...
                                >
                                <Input style={{width:360}}/> &nbsp; &nbsp; <span className='font-blue'>Goods Description</span> 
                            </Form.Item>
  
                        </Col>

                        <Col span={6}>Invoice Value : </Col>
                        <Col span={18}>
                            <Form.Item
                                //label="Invoice Value"
                                name="invoice_value"
